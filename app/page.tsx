            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 stagger-children max-w-4xl mx-auto">
                {[
                  ...
                  <div
                    key={area}
                    className="group/item relative bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden"
