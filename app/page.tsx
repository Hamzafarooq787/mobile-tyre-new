...
export default function Home() {
  ...
  <div className="relative group overflow-hidden rounded-3xl bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-2">
    ...
    <div className="relative z-10">
      ...
      <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-3xl animate-fade-in-up delay-150">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
        {[
          ...
          <div
            key={index}
            className="flex flex-col gap-3 rounded-2xl border border-slate-100 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-6 transition-all duration-500 hover:bg-primary/5 hover:scale-110 hover:shadow-2xl animate-fade-in-up"
          ...
          >
            ...
            <div className="animate-fade-in">
              <div className="relative group overflow-hidden rounded-3xl bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 p-8 lg:p-10 shadow-xl hover:shadow-2xl transition-all duration-700 hover:-translate-y-2">
                ...
                <div className="absolute -bottom-32 -left-32 w-64 h-64 bg-accent/20 rounded-full blur-3xl animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-700 delay-300"></div>
                ...
                {/* Floating Icons (same style, maybe repositioned) */}
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                  <div className="absolute top-6 left-6 w-16 h-16 text-primary/20 animate-float-slow">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                      <circle cx="12" cy="12" r="8" stroke="currentColor" strokeWidth="2" fill="none" />
                      <circle cx="12" cy="12" r="4" stroke="currentColor" strokeWidth="2" fill="none" />
                      <line x1="12" y1="4" x2="12" y2="20" stroke="currentColor" strokeWidth="2" />
                  ...
                  <div className="absolute bottom-8 right-8 w-20 h-20 text-accent/20 animate-float" style={{ animationDelay: '1s' }}>
                    <svg viewBox="0 0 24 24" fill="currentColor">
                      <path d="M22 14h-1.5l-1.7-3.4c-.3-.6-1-1-1.7-1H7.9c-.7 0-1.4.4-1.7 1L4.5 14H3v5h2v1c0 .6.4 1 1 1h2c.6 0 1-.4 1-1v-1h8v1c0 .6.4 1 1 1h2c.6 0 1-.4 1-1v-1h2v-5zM7.9 10h8.2l1.5 3H6.4l1.5-3zM5 15h14v2H5v-2z" />
                    </svg>
                  </div>
                  <div className="absolute top-16 right-16 w-14 h-14 text-primary/20 animate-spin-slow">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="2" fill="none" />
                      <circle cx="12" cy="12" r="5" stroke="currentColor" strokeWidth="2" fill="none" />
                    </svg>
                  </div>
                  <div className="absolute bottom-12 left-8 w-16 h-16 text-accent/20 animate-float" style={{ animationDelay: '2s' }}>
                    <svg viewBox="0 0 24 24" fill="currentColor">
                      <path d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5h-11c-.66 0-1.21.42-1.42 1.01L3 12v8c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h12v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-8l-2.08-5.99zM6.5 16c-.83 0-1.5-.67-1.5-1.5S5.67 13 6.5 13s1.5.67 1.5 1.5S7.33 16 6.5 16zm11 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM5 11l1.5-4.5h11L19 11H5z" />
                    </svg>
                  </div>
                ...
                <div className="relative z-10">
                  <div className="text-center mb-8 animate-fade-in-up">
                    <h3 className="text-3xl lg:text-4xl font-bold mb-3 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                      Our Service Areas
                    </h3>
                    <p className="text-base sm:text-lg text-slate-600 dark:text-gray-400">
                      Proudly serving across Leicestershire and surrounding communities
                    </p>
                    <div className="w-24 h-1 bg-gradient-to-r from-primary to-accent mx-auto mt-3 rounded-full"></div>
                  </div>

                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 stagger-children max-w-4xl mx-auto">
                    {[
                      "Leicester", "Loughborough", "Hinckley", "Coalville",
                      "Market Harborough", "Melton Mowbray", "Oadby", "Wigston",
                      "Ashby-de-la-Zouch", "Lutterworth", "Shepshed", "Birstall"
                    ].map((area, index) => (
                      <div
                        key={area}
                        className="group/item relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-4 text-center shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden"
                        style={{ animationDelay: `${index * 0.05}s` }}
                      >
                        <div className="absolute inset-0 bg-gradient-to-r from-primary/10 to-accent/10 opacity-0 group-hover/item:opacity-100 transition-opacity duration-300"></div>
                        ...
                        <span className="text-sm sm:text-base font-medium relative z-10">{area}</span>
                      </div>
                    ))}
                  </div>

                  <p className="text-sm text-center text-slate-500 mt-8 animate-fade-in-up delay-500">
                    Not sure if we cover your area?{" "}
                    <Link
                      href="/contact"
                      className="relative text-primary font-bold group/link animate-pulse hover:animate-none"
                    >
                      Contact us
                      <span className="absolute -bottom-0.5 left-0 w-0 h-0.5 bg-primary group-hover/link:w-full transition-all duration-300"></span>
                    </Link>
                  </p>
                </div>
              </div>
