    ...
    <section className="py-16 px-4 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-white border border-slate-100 rounded-2xl p-6 transition-all duration-500 hover:-translate-y-2 hover:border-primary hover:shadow-xl hover:shadow-primary/10 animate-fade-in-up"
    ...
    <section className="bg-slate-50 py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-slate-600 animate-slide-in-right delay-150">
            Transparent pricing for our mobile call-out services across the region.
          </p>
        </div>
        
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-2xl transition-all duration-500 animate-fade-in-up">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100">
              {[
                ...
                <tr 
                  key={index}
                  className="hover:bg-slate-50 transition-colors duration-300 animate-fade-in-right"
