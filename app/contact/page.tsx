          ...
          <div className="space-y-8 animate-fade-in-left">
            ...
            <div className="relative overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 h-64 bg-slate-200 dark:bg-slate-800 group animate-fade-in-up delay-500">
              ...
              <div className="absolute inset-0 flex items-center justify-center px-4">
                <div className="bg-white dark:bg-slate-900 p-4 rounded-lg shadow-xl border border-slate-100 dark:border-slate-800 flex items-center gap-3 transform hover:scale-110 transition-transform duration-300 animate-bounce-gentle max-w-[250px]">
